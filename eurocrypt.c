...
const static ec_mode_t _ec_modes[] = {
	...
	{ "cplus",     EC_3DES, EC_3DES, { 0xC8, 0x91, 0xB4, 0xF5, 0x59, 0xCE, 0x86, 0x00,  /* Key 02 and key 03 - index key E */
...
const static em_mode_t _em_modes[] = {
	...
	{ "cplus",     EC_3DES, EC_3DES, { 0x00, 0x20, 0x20, 0x02, 0x00, 0x02, 0x00, 0x00,
	                                   0x8B, 0xBE, 0xD4, 0x7C, 0xF8, 0x8A, 0x7A, 0x00 }, { 0x00, 0x2B, 0x00 }, { 0x9B, 0x54, 0x3F }, { 0x4D, 0x19, 0x7A, 0x31, 0x00 }, EMMU },
	{ NULL } 
};
